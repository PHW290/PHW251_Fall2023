...
It's good to look around at sites like github, stack overflow, and rstudio community sites to see how other users produce their reprex and how they are received by other commenters. It's also good to make sure your code is well organized and never a bad time to check whether your code follows [a style guide](https://reprex.tidyverse.org/articles/reprex-dos-and-donts.html)
