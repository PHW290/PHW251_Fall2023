...
v <- c("Monday", "Tuesday", "Wednesday", "Thursday")
...
if(any(c("peach", "apple", "grape") == "orange") == FALSE){print("Low on oranges!")}
  
  any(c(1,5,8,9,7) > 5)

any(c("peach", "apple", "grape") == "orange")
...
```{r}
sample_temperatures <- c(20, 25, 32, 38, 28, 27, 23, 23, 14, 14, 24, 20)
...
print(paste0(county[1], " case rate: ", round((cases[1] / pops[1]), 3)))
print(paste0(county[2], " case rate: ",case_rate[1]))
print(paste0(county[3], " case rate: ",case_rate[1]))
